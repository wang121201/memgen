#!/usr/bin/env python3
"""Build one fail-closed HBServe profile for every kernel in a sparse run."""
...
def main() -> int:
    ...
    try:
        with index_path.open("xb") as index_stream:
            for position, row in enumerate(rows, 1):
                ...
                output = profiles_root / f"kernel_{kernel}.profile.json"
                ...
                index_row = {
                    ...
                    "sha256": tool.sha256_file(output),
                }
