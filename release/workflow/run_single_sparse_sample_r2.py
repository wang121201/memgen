...
def main() -> int:
    ...
    parser.add_argument(
        "--plan-root",
        type=Path,
        default=ROOT / "sample-plans-r3",
        help="frozen plan directory containing p<P>d32.tsv and its receipt",
    )
    ...
    plan = plan_root / f"p{args.prompt}d32.tsv"
    plan_receipt_path = plan_root / f"p{args.prompt}d32.json"
