...
TRACER = ROOT / "sample-tracer-r4/memory_tracer_sample_r4.so"
PLAN = ROOT / "sample-plans-r3/p64d32.tsv"
PLAN_RECEIPT = ROOT / "sample-plans-r3/p64d32.json"
OUTPUT = ROOT / "samples/p64d32-r2"
...
EXPECTED_SHA256 = {
    ...
    TRACER: "8bf53876b32803f24a8e75bf4637208886217791a0837310ae4f7781a982e8ff",
}
    ...
    env.update(
        {
            ...
            "LLMGPUSIM_CAPTURE_RUN_ID": "p64d32-full-inference-sparse-sample-r2",
        }
    )
