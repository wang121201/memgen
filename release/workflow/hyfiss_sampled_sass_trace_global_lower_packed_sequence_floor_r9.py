...
def fit_x_floor_quotient(
    ...
    require(
        any(
            first_block != second_block and first_address == second_address
            for first_block, first_address in ordered
            for second_block, second_address in ordered
        ),
        f"{label}: x-floor rule requires an observed within-group address plateau",
    )
    ...
    return {
        ...
        "scope": "one_dimensional_grid_unique_training_fit",
    }
