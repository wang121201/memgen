...
DECODE_STEPS = 32
RUNS = (
    (128, "GPU-18ace299-5348-e6e4-d48c-1ee5a602859b", "p128d32-r2"),
    (256, "GPU-7a22d253-7921-4e49-992e-0199eebd6f86", "p256d32-r2"),
    (512, "GPU-53a2015e-19cf-83d7-cbc8-fac96aab7d38", "p512d32-r2"),
    (1024, "GPU-69cebdc2-40c1-603a-aa3d-991cd3fbac13", "p1024d32-r2"),
)
...
def main() -> int:
        ...
        env.update(
            {
                ...
                "LLMGPUSIM_CAPTURE_RUN_ID": f"p{prompt}d{DECODE_STEPS}-placement-r2",
            }
        )
    ...
    manifest_path = EXPERIMENT_ROOT / "placement/parallel-p128-p1024-r2.json"
